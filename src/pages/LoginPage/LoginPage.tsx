    ...
    return (
        <div className={scss.login}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <p>Before logging in, please register an account on the official
                    <a target="_blank" href={'https://www.themoviedb.org/signup'}> website </a>
                    and then enter your username and password here<br/>
                </p>
